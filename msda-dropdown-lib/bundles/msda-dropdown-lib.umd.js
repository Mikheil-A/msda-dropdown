(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('msda-dropdown-lib', ['exports', '@angular/core', '@angular/common/http', '@angular/common'], factory) :
    (global = global || self, factory(global['msda-dropdown-lib'] = {}, global.ng.core, global.ng.common.http, global.ng.common));
     ...
     */
    var MsdaDropdownLibService = /** @class */ (function () {
        function MsdaDropdownLibService() {
        }
        ...
        /** @nocollapse */
        MsdaDropdownLibService.ctorParameters = function () { return []; };
        /** @nocollapse */ MsdaDropdownLibService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function MsdaDropdownLibService_Factory() { return new MsdaDropdownLibService(); }, token: MsdaDropdownLibService, providedIn: "root" });
        return MsdaDropdownLibService;
    }());
    ...
    var MsdaDropdownLibComponent = /** @class */ (function () {
        ...
        MsdaDropdownLibComponent.propDecorators = {
            navItemRefs: [{ type: core.ViewChildren, args: ['navItemRef',] }],
            sectionElRefs: [{ type: core.ViewChildren, args: ['sectionElRef',] }],
            popoverElRef: [{ type: core.ViewChild, args: ['popoverElRef', { static: true },] }],
            headerElRef: [{ type: core.ViewChild, args: ['headerElRef', { static: true },] }],
            arrowElRef: [{ type: core.ViewChild, args: ['arrowElRef', { static: true },] }],
            contentElRef: [{ type: core.ViewChild, args: ['contentElRef', { static: true },] }],
            backgroundElRef: [{ type: core.ViewChild, args: ['backgroundElRef', { static: true },] }],
     ...
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var MsdaDropdownLibModule = /** @class */ (function () {
        function MsdaDropdownLibModule() {
        }
        ...
        return MsdaDropdownLibModule;
    }());

    exports.MsdaDropdownLibComponent = MsdaDropdownLibComponent;
    exports.MsdaDropdownLibModule = MsdaDropdownLibModule;
    exports.MsdaDropdownLibService = MsdaDropdownLibService;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=msda-dropdown-lib.umd.js.map
